...
public class IpsecFirstPacketsDump {
    ...
    public static void main(String[] args) throws Exception {
        ...
        for (PcapPacket pkt : packets) {
            ...
            String next = (String) h.get("nextPayload");
            boolean phase1 = next != null && next.startsWith("1 (");
            // dump first 4 unencrypted Phase 1 / SA messages
            if (printed < 6 && (!encrypted || phase1)) {
